...
4.  **[OUTPUT]** The strict schema definition block.
5.  **[DATA HEADERS]** The injection payloads (e.g., `[USER PROFILE]`, `[TEXT TO ANALYZE]`).
...
### 2. `prompts/menu_extract.txt`
Updated to the bracketed format.
